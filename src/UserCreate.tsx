...
export default function UserCreate() {
  ...
  useEffect(() => { listEntities().then(rows => setEntities(rows.filter((e:any)=>ALLOWED_SECTORS.includes(e.name)))); }, []);
  ...
  return (
    <>
      ...
      <p className="sub">O utilizador é criado já associado a uma Sector (cliente).</p>
